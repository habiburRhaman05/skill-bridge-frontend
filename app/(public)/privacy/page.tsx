...
const sections = [
  ...
  },
  {
    ...
    content: `We use collected information to provide and improve our services, process transactions, send notifications about bookings, personalize your experience, and communicate with you about platform updates. We may also use aggregated data for analytics to improve the overall SkillBridge experience.`,
  },
  {
  ...
  {
    title: "6. Your Rights",
    content: `You have the right to access, update, or delete your personal data at any time through your account settings. You can also request a copy of your data, object to certain processing activities, and withdraw consent where applicable. To exercise these rights, contact us at privacy@skillbridge.com.`,
  },
  {
    title: "7. Children's Privacy",
    content: `SkillBridge is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13. If we discover we have collected information from a child under 13, we will delete it immediately.`,
  },
  {
        ...
        <div className="bg-card rounded-[32px] border border-border p-8 md:p-12 space-y-10">
          ...
          <div className="pt-8 border-t border-border">
            <p className="text-sm text-muted-foreground font-medium">
              ...
              <a href="mailto:privacy@skillbridge.com" className="text-indigo-600 font-bold hover:underline">
