...
const sections = [
  {
    ...
    content: `By accessing and using SkillBridge, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using this platform.`,
  },
  {
    title: "2. User Accounts",
    content: `You must create an account to use most features of SkillBridge. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You must provide accurate and complete information during registration and keep your account information up to date.`,
  },
  {
    title: "3. User Roles",
    content: `SkillBridge supports three types of users: Students, Tutors, and Administrators. Each role has specific privileges and responsibilities. Students can browse tutors, book sessions, and leave reviews. Tutors can create profiles, set availability, and manage sessions. Misuse of role privileges may result in account suspension.`,
  },
  {
    title: "4. Booking & Payments",
    content: `All bookings are made through the SkillBridge platform. Payment is processed at the time of booking. Tutors set their own hourly rates. SkillBridge may charge a service fee on each transaction. All prices are displayed in USD unless otherwise specified.`,
  },
  {
  ...
  },
  {
    ...
    content: `All content on SkillBridge, including but not limited to text, graphics, logos, and software, is the property of SkillBridge or its content providers. You may not reproduce, distribute, or create derivative works from any content without our explicit written permission.`,
  },
  {
    title: "8. Limitation of Liability",
    content: `SkillBridge provides the platform "as is" and makes no warranties about the quality of tutoring services. We are not liable for any indirect, incidental, or consequential damages arising from the use of our platform. Our total liability shall not exceed the amount paid by you in the preceding 12 months.`,
  },
  {
    title: "9. Termination",
  ...
  },
  {
    ...
    content: `We reserve the right to modify these terms at any time. Changes will be effective immediately upon posting. Your continued use of SkillBridge after changes constitutes acceptance of the modified terms. We will notify users of significant changes via email.`,
  },
];
      ...
      <section className="max-w-3xl mx-auto px-6">
        <div className="bg-card rounded-[32px] border border-border p-8 md:p-12 space-y-10">
          <p className="text-muted-foreground font-medium leading-relaxed">
            Welcome to SkillBridge. These Terms of Service govern your use of our platform
            and services. By using SkillBridge, you agree to comply with these terms.
          </p>
          ...
          <div className="pt-8 border-t border-border">
            <p className="text-sm text-muted-foreground font-medium">
              ...
              <a href="mailto:legal@skillbridge.com" className="text-indigo-600 font-bold hover:underline">
