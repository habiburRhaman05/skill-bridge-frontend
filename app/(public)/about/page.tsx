      ...
      <section className="pt-32 pb-20 px-6 text-center">
        <motion.div {...fadeInUp} className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground font-medium leading-relaxed max-w-2xl mx-auto">
            ...
            Founded in 2026, SkillBridge connects ambitious learners with world-class experts.
          </p>
        </motion.div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeInUp}>
            ...
            <p className="text-muted-foreground font-medium leading-relaxed mb-6">
              ...
              1-on-1 learning is the most effective way to master any skill. SkillBridge
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <p className="text-muted-foreground font-medium text-lg">The people making SkillBridge possible.</p>
          </motion.div>
